...
this["JST"]["templatesfolder/bubble-template.handlebars"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["JST"]["templatesfolder/content-template.handlebars"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
...
this["JST"]["templatesfolder/provider-list.handlebars"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "     <option value=\""
...
this["JST"]["templatesfolder/tab-template.handlebars"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  stack1 = helpers['if'].call(depth0, (data && data.first), {"name":"if","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
